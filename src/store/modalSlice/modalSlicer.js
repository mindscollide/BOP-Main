...
const initialState = {
  ...
  discountingRFQQuoteModal: false,
  forwardRFQQuoteModal: false,
  viewDealModal: false, // Controls the visibility of the "View Deal" modal.
...
const modalSlice = createSlice({
  ...
  reducers: {
    setDiscountingRFQQuoteModal(state, { payload }) {
      state.discountingRFQQuoteModal = payload;
    },
    setForwardRFQQuoteModal(state, { payload }) {
      state.forwardRFQQuoteModal = payload;
    },
    ...
    setViewDealModal(state, { payload }) {
      state.viewDealModal = payload; // Updates the state with the payload value.
    },
...
export const {
  setForwardRFQQuoteModal,
  setDiscountingRFQQuoteModal,
  setIBuySellData,
