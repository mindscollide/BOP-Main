...
import { validateLinkForCorporateCreatePasswordApi } from "../CreatePassword/createPassword_Action";
import { CreateCorporateUserForgotPasswordApi } from "./changePasswordActions";
const ChangePassword = () => {
  ...
  useEffect(() => {
    if (location.search.includes("action_changePassword")) {
      let validateValue = location.search.split("action_changePassword=")[1];
      ...
      <Row>
        ...
        <Col sm={12} md={12} lg={12}>
          <section className={styles["LoginCard"]}>
            <h4 className={styles["Heading-js"]}>Change Password</h4>
