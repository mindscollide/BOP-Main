  ...
  renderErrorDetails() {
    ...
    if (this.isCSSPreloadError(error)) {
      return (
        <div>
          ...
          <p>The styles didn't load properly. The page might look unusual but should still work.</p>
    ...
    if (this.isChunkLoadError(error) || this.isNetworkError(error)) {
      return (
        <div>
          ...
          <p>There was a problem loading the application. This might be due to a poor network connection.</p>
    ...
    return (
      <div>
        ...
        <details style={{ whiteSpace: 'pre-wrap', textAlign: 'left', margin: '1em 0' }}>
